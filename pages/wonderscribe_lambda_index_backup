    ...
    try:
        ...
        prompt = f""" 
                ...
                Give response in Json format by following below instruction,
                    ...
                    4) The caption should contain a caption based on a story text, and that can be used as a prompt for a stable diffusion model. Remove the filtered word from the caption. The main character should be the same, and animated images should be generated without text in the images.
